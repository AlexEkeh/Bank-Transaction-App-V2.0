...
const getTransactionSchema = joi_1.default.object({
    page: joi_1.default.number().min(1),
    limit: joi_1.default.number().min(1)
});
function getAllTransactionValidator(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield getTransactionSchema.validateAsync(req.query, { abortEarly: false });
            next();
        }
        catch (error) {
...
exports.default = getAllTransactionValidator;
