...
const transferSchema = joi_1.default.object({
    senderAccount: joi_1.default.number().min(1).required(),
    receiverAccount: joi_1.default.number().disallow(joi_1.default.ref('senderAccount')).min(1).required(),
    amount: joi_1.default.number().min(1).required()
});
function transferValidator(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield transferSchema.validateAsync(req.body, { abortEarly: false });
            next();
        }
        catch (error) {
